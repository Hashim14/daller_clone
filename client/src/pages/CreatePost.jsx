  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-[#666e75] text-[#16px] max-w[500px] mt-2">
      ...
      <form className="mt-16 max-w-3xl" onClick={handleSubmit}>
        <div>
          ...
          />
          <div className="mb-5 relative flex bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 h-64 p-3 justify-center items-center">
            {form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
